 ...
 */
public class CreateHospAdmin extends javax.swing.JPanel {

    /**
     * Creates new form CreateHospAdmin
     */
    Operations ops;
    ...
    public CreateHospAdmin(MainSys mainSystem, CredentialDirectory cred) {
        initComponents();
        this.ops = ops;
        this.cred = cred;
    ...
    private void populateTable() {
        ...
        for (City city : mainSystem.getAllcities()) {
            ...
            row[0] = city;
            row[1] = city.getCityId();
            for (Hospital com1 : city.getAllHospitals()) {
                row[2] = com1.getCommunity().getCommunityName();
                for (Community comm : city.searchCommunity(com1.getCommunityName())) {
